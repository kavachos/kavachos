...
async function main(): Promise<void> {
	...
	//
	// KavachOS uses Drizzle ORM. In a real application you would run migrations
	// generated by `pnpm drizzle-kit push`. For this example we create tables
	// directly via raw SQL so the example runs without any migration tooling.
	//
