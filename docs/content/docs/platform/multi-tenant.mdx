...
<Cards>
  <Card title="Budget policies" description="Apply cost limits at the tenant, agent, or user level." href="/docs/guides/budget-policies" />
  <Card title="Agent identity" description="Create agents scoped to a tenant." href="/docs/core/agents" />
  <Card title="Audit log" description="Filter the audit trail by tenant." href="/docs/core/audit" />
</Cards>
