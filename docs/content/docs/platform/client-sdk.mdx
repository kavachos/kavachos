...
<Cards>
  <Card title="Agent identity" description="Understand the agent model before building integrations." href="/docs/core/agents" />
  <Card title="Audit log" description="Querying and exporting the audit trail." href="/docs/core/audit" />
  <Card title="Delegation chains" description="How delegated permissions work." href="/docs/core/delegation" />
</Cards>
