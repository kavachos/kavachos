...
<Cards>
  <Card title="Agent identity" description="Create and manage the agents that publish cards." href="/docs/core/agents" />
  <Card title="Multi-tenant isolation" description="Scope discovery to a specific tenant." href="/docs/platform/multi-tenant" />
  <Card title="MCP OAuth 2.1" description="Add auth requirements to your MCP-based agents." href="/docs/platform/mcp" />
</Cards>
