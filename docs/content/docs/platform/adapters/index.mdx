...
<Cards>
  <Card title="Hono" description="Lightweight, fast, runs everywhere." href="/docs/platform/adapters/hono" />
  <Card title="Express" description="The most widely used Node.js framework." href="/docs/platform/adapters/express" />
  <Card title="Next.js" description="App Router with catch-all route handler." href="/docs/platform/adapters/nextjs" />
  <Card title="Fastify" description="High-performance with plugin architecture." href="/docs/platform/adapters/fastify" />
  <Card title="Nuxt" description="Vue-based with H3 server routes." href="/docs/platform/adapters/nuxt" />
  <Card title="SvelteKit" description="Svelte with +server.ts handlers." href="/docs/platform/adapters/sveltekit" />
  <Card title="Astro" description="Content-focused with API routes." href="/docs/platform/adapters/astro" />
</Cards>
