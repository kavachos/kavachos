...
<Cards>
  <Card title="Budget policies" description="Set hard limits and choose what happens when they are exceeded." href="/docs/budget-policies" />
  <Card title="Audit log" description="Full reference for audit log queries and export options." href="/docs/audit" />
  <Card title="Telemetry" description="Route authorization events to Datadog, Grafana, or any OTel backend." href="/docs/telemetry" />
</Cards>
