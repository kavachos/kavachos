...
<Cards>
  <Card title="Compliance" description="Map audit data to EU AI Act, NIST, SOC 2, and ISO 42001." href="/docs/guides/compliance" />
  <Card title="REST API" description="Query audit logs via HTTP endpoints." href="/docs/reference/api" />
  <Card title="Admin dashboard" description="Visual audit log viewer with filters and export." href="/docs/platform/dashboard" />
</Cards>
