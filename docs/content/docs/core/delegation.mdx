...
<Cards>
  <Card title="Audit trail" description="Every delegation is logged with agent and depth info." href="/docs/core/audit" />
  <Card title="Agent identity" description="Create the agents that participate in delegation chains." href="/docs/core/agents" />
  <Card title="MCP OAuth 2.1" description="Use delegation with MCP-authenticated agents." href="/docs/platform/mcp" />
</Cards>
