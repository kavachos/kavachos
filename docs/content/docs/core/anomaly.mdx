...
<Cards>
  <Card title="Trust scoring" description="Translate anomaly counts into a graduated trust level." href="/docs/core/trust" />
  <Card title="Approval flows" description="Route flagged agents through human review before they act." href="/docs/core/approval" />
  <Card title="Audit trail" description="Query the raw log data that anomaly detection reads." href="/docs/core/audit" />
</Cards>
