...
<Cards>
  <Card title="Anomaly detection" description="Surface unusual patterns in agent behavior." href="/docs/core/anomaly" />
  <Card title="Approval flows" description="Route high-risk actions through human review." href="/docs/core/approval" />
  <Card title="Audit trail" description="The raw data that feeds trust scoring." href="/docs/core/audit" />
</Cards>
