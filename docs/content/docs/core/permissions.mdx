...
<Cards>
  <Card title="Delegation chains" description="Delegate permission subsets to other agents." href="/docs/core/delegation" />
  <Card title="Audit trail" description="See how permissions are logged on every call." href="/docs/core/audit" />
  <Card title="Compliance" description="Map permissions to EU AI Act and NIST requirements." href="/docs/guides/compliance" />
</Cards>
