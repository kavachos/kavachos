...
<Cards>
  <Card title="Permissions" description="Add requireApproval constraints to individual permissions." href="/docs/core/permissions" />
  <Card title="Trust scoring" description="Use trust levels to decide which agents need approval." href="/docs/core/trust" />
  <Card title="Audit trail" description="Every approval decision is linked to an audit entry." href="/docs/core/audit" />
</Cards>
