...
<Cards>
  <Card title="Permissions" description="Define precise grants instead of broad wildcards." href="/docs/permissions" />
  <Card title="Trust scoring" description="Complement privilege analysis with behavioral trust scores." href="/docs/trust" />
  <Card title="Audit trail" description="The activity data the analyzer reads." href="/docs/audit" />
</Cards>
