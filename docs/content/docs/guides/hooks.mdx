...
<Cards>
  <Card title="Budget policies" description="Block agents when they exceed token or call limits." href="/docs/guides/budget-policies" />
  <Card title="Telemetry" description="Export authorization events as OpenTelemetry spans." href="/docs/guides/telemetry" />
  <Card title="Audit log" description="Query the immutable record of every authorization decision." href="/docs/core/audit" />
</Cards>
