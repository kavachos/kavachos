...
<Cards>
  <Card title="Lifecycle hooks" description="Fire custom callbacks at authorization and agent events." href="/docs/guides/hooks" />
  <Card title="Cost tracking" description="Aggregate token costs across agents and days." href="/docs/guides/cost-tracking" />
  <Card title="Audit log" description="Query the raw audit trail without OTel." href="/docs/core/audit" />
</Cards>
