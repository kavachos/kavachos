...
<Cards>
  <Card title="Permission engine" description="Define what your agents can and cannot do." href="/docs/permissions" />
  <Card title="Delegation chains" description="Let agents delegate access to sub-agents." href="/docs/delegation" />
  <Card title="Token-based auth with adapters" description="Use agents in HTTP middleware." href="/docs/adapters" />
</Cards>
