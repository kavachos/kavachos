...
<Cards>
  <Card title="Permission engine" description="Wildcards, rate limits, time windows, IP allowlists, and approval gates." href="/docs/core/permissions" />
  <Card title="Delegation chains" description="Sub-agent delegation with depth limits and cascading revocation." href="/docs/core/delegation" />
  <Card title="MCP OAuth 2.1" description="Set up the authorization server for MCP tool servers." href="/docs/platform/mcp" />
  <Card title="Framework adapters" description="Drop-in middleware for Hono, Express, Next.js, and 4 more." href="/docs/platform/adapters" />
  <Card title="Auth adapters" description="Plug into better-auth, Auth.js, Clerk, or bring your own." href="/docs/guides/auth-adapters" />
  <Card title="Configuration" description="All createKavach() options and environment patterns." href="/docs/guides/configuration" />
</Cards>
